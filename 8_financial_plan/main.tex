...
So long as Cereus has at least one personal tier subscriber during the first year and an initial contribution of \$8,500.00 is made by the founders, the company will be cash-positive (though not profitable). Given the forecasted sales in Table \ref{table.sales.forecast}, Cereus will be profitable within six months and have a cash balance of \$11,354.00 by the end of the year (Table \ref{table.cash.flow}).
