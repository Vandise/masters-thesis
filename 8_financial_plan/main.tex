...
Cereus's financial plan is based on the operational costs described in \nameref{section.admin.costs}. Forecasted sales for our first year can be found in Table \ref{table.sales.forecast} and start up expenses in the \nameref{startup.exp} section. Supplier billing takes place every 30 days (\nameref{infra.costs}) and customers are billed the first of each month (\nameref{transaction.process}).
