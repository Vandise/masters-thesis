...
\noindent
Given Amazon's 720 hour billing cycle (30 days) \cite{aws.calc.2020}, estimated starting costs for infrastructure to support the auditing of 100 websites with the following:
...
\noindent
results with an estimated monthly cost of \$157.14 per month for infrastructure operations.
