...
The costs between our queue, email, scan, database backup, and audit systems were also reflected in the cost explorer. Due to these systems being part of our standard infrastructure operations (\nameref{section.operational.costs}), the costs associated with these had to be estimated.
...
Based on the marketing and promotional strategies outlined in the \nameref{marketing.ad.promo} section, a 12-month sales forecast was generated under the following assumptions:
